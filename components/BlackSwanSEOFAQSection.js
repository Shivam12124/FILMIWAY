// components/BlackSwanSEOFAQSection.js - MATCHING INCEPTION DESIGN ✅
...
const BlackSwanSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Black Swan FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and this psychological descent into artistic obsession.
            </p>
...
export default BlackSwanSEOFAQSection;
