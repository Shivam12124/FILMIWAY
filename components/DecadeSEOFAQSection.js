// components/DecadeSEOFAQSection.js - MATCHING COLLECTION DESIGN ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
// ✅ Pull in the unified UI generator from your new decade data file
import { getVisibleMovieFAQs } from '../utils/decadeMovieData';

const DecadeSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Decade FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and its defining impact on modern cinema.
            </p>
...
export default DecadeSEOFAQSection;