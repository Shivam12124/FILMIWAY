// components/PeacockRomanceSEOFAQSection.js - DYNAMIC & SEO OPTIMIZED ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
// 🔥 IMPORT THE DYNAMIC FAQ GENERATOR
import { getVisibleMovieFAQs } from '../utils/peacockRomanceMovieData';
...
const PeacockRomanceSEOFAQSection = ({ movie }) => {
    ...
    return (
        ...
        >
            {/* 🎨 Warm Pink/Rose Theme for the Romance Collection */}
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
                Explore our **Parents Guide** and expert analysis for {title}. We provide accurate timestamps for sensitive scenes to skip and map the emotional intensity of this Peacock romance.
            </p>
            ...
            <div className="space-y-4 sm:space-y-6">
                {faqsFromData.map((faq, index) => (
                    ...
                    >
                        ...
                        <h3 className="text-base sm:text-lg font-medium text-rose-200 mb-2 sm:mb-3 leading-relaxed">
                            {faq.question || faq.q}
                        </h3>
