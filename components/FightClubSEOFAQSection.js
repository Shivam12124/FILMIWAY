// components/FightClubSEOFAQSection.js - MATCHING INCEPTION DESIGN ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
// 🔥 IMPORT THE NEW DYNAMIC FAQ GENERATOR
import { COMPLETE_MOVIE_DATA as FIGHT_CLUB_MOVIE_DATA, getVisibleMovieFAQs } from '../utils/fightClubMovieData';

const FightClubSEOFAQSection = ({ movie }) => {
    const movieInfo = FIGHT_CLUB_MOVIE_DATA[movie?.tmdbId];
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Fight Club FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie?.Title} and its exploration of identity fracture, anti-system rebellion, and dark satire.
            </p>
...
export default FightClubSEOFAQSection;