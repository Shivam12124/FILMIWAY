// components/A24SEOFAQSection.js - MATCHING INCEPTION DESIGN ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
// 🔥 IMPORT THE NEW DYNAMIC FAQ GENERATOR
import { COMPLETE_MOVIE_DATA as A24_MOVIE_DATA, getVisibleMovieFAQs } from '../utils/a24MovieData';

const A24SEOFAQSection = ({ movie }) => {
    const movieInfo = A24_MOVIE_DATA[movie?.tmdbId];
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No A24 FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie?.Title} and its exploration of profound human emotion, surreal horror, and undeniable artistic vision.
            </p>
...
export default A24SEOFAQSection;