// components/PeacockFamilySEOFAQSection.js - DYNAMIC & SEO OPTIMIZED ✅
import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { Sparkles, ChevronDown, ChevronUp } from 'lucide-react'; // Matches the Family vibe
// 🔥 IMPORT THE DYNAMIC FAQ GENERATOR
import { getVisibleMovieFAQs } from '../utils/peacockFamilyMovieData';
...
const PeacockFamilySEOFAQSection = ({ movie }) => {
    ...
    return (
        ...
        >
            {/* 🎨 Yellow/Amber Theme for the Family Collection */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 sm:mb-10 gap-4">
                <div>
                    ...
                    <p className="text-gray-400 mt-2 text-sm sm:text-base max-w-2xl leading-relaxed">
                        Explore our **Parents Guide** and expert analysis for {title}. We provide accurate timestamps for sensitive scenes to skip and map the biggest fun factor peaks of this Peacock family hit.
                    </p>
                </div>
            </div>
