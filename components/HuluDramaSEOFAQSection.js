// components/HuluDramaSEOFAQSection.js - MATCHING DRAMA DESIGN (Blue/Slate Theme) ✅
...
const HuluDramaSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Hulu Drama FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and its themes of emotion and human connection.
            </p>
...
export default HuluDramaSEOFAQSection;