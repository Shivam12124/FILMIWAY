// components/HboMaxThrillerSEOFAQSection.js - MATCHING THRILLER DESIGN ✅
...
const HboMaxThrillerSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No HBO Max Thriller FAQs found for:', movie?.Title);
        return null;
    }
...
export default HboMaxThrillerSEOFAQSection;