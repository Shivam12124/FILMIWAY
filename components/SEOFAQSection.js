// components/SEOFAQSection.js - MATCHING DYNAMIC DESIGN ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
// 🔥 IMPORT THE DYNAMIC GENERATOR (Exactly like the other collections)
import { 
    COMPLETE_MOVIE_DATA, 
    getVisibleMovieFAQs 
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and its mind-bending narrative.
            </p>
