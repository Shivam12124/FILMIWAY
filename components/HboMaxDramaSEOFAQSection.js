...
import { HBO_DRAMA_MOVIE_FAQS } from '../utils/hboMaxDramaMovieData';

const HboMaxDramaSEOFAQSection = ({ movie }) => {
    // 🔥 Get FAQs from HBO_DRAMA_MOVIE_FAQS data
    const faqsFromData = movie?.Title && HBO_DRAMA_MOVIE_FAQS?.[movie.Title] 
        ? HBO_DRAMA_MOVIE_FAQS[movie.Title] 
        : [];
