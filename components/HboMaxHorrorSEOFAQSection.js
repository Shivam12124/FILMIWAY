// components/HboMaxHorrorSEOFAQSection.js - MATCHING HORROR DESIGN (BLOOD RED) ✅
...
const HboMaxHorrorSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No HBO Max Horror FAQs found for:', movie?.Title);
        return null;
    }
...
export default HboMaxHorrorSEOFAQSection;