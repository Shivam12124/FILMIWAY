// components/ParamountFamilySEOFAQSection.js - DYNAMIC & SEO OPTIMIZED ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Sparkles } from 'lucide-react'; // Matches the Magical/Whimsical vibe
// 🔥 IMPORT THE DYNAMIC FAQ GENERATOR
import { getVisibleMovieFAQs } from '../utils/paramountFamilyMovieData';
...
const ParamountFamilySEOFAQSection = ({ movie }) => {
    ...
    return (
        ...
        >
            {/* 🎨 Bright Yellow Theme for the Paramount+ Family Collection */}
