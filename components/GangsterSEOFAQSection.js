// components/GangsterSEOFAQSection.js - MATCHING COLLECTION DESIGN ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
// ✅ Pull in the unified UI generator from your new gangster data file
import { getVisibleMovieFAQs } from '../utils/gangsterMovieData';

const GangsterSEOFAQSection = ({ movie }) => {
    
    // 🔥 Get the dynamically generated FAQs (Includes Timestamps, Impact, and Static FAQs)
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Gangster FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and its place in the cinematic criminal underworld.
            </p>
...
export default GangsterSEOFAQSection;