// components/ParamountSciFiSEOFAQSection.js - COSMIC SCI-FI THEME (CYAN/BLUE) ✅
...
const ParamountSciFiSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Paramount Sci-Fi FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Deep dive into the themes, scientific accuracy, and production of {movie.Title}.
            </p>
...
export default ParamountSciFiSEOFAQSection;