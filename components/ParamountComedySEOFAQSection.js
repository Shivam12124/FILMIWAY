// components/ParamountComedySEOFAQSection.js - DYNAMIC & SEO OPTIMIZED ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Smile } from 'lucide-react'; // Matches the Comedy vibe
// 🔥 IMPORT THE DYNAMIC FAQ GENERATOR
import { getVisibleMovieFAQs } from '../utils/paramountComedyMovieData';
...
const ParamountComedySEOFAQSection = ({ movie }) => {
    ...
    return (
        ...
        >
            {/* 🎨 Bright Yellow/Gold Theme for the Paramount+ Comedy Collection */}
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
                Explore our **Parents Guide** and expert analysis for {title}. We provide accurate timestamps for sensitive scenes to skip and map the biggest laughs of this Paramount+ comedy hit.
            </p>
