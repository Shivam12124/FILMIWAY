// components/PeacockComedySEOFAQSection.js - MATCHING COMEDY DESIGN ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
import { PEACOCK_COMEDY_MOVIE_FAQS } from '../utils/peacockComedyMovieData';

const PeacockComedySEOFAQSection = ({ movie }) => {
    // 🔥 Get FAQs from PEACOCK_COMEDY_MOVIE_FAQS data
    const faqsFromData = movie?.Title && PEACOCK_COMEDY_MOVIE_FAQS?.[movie.Title] 
        ? PEACOCK_COMEDY_MOVIE_FAQS[movie.Title] 
        : [];
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and its lasting impact on comedy history.
            </p>
