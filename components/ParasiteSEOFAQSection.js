// components/ParasiteSEOFAQSection.js - MATCHING SURVIVAL/INCEPTION DESIGN ✅
...
const ParasiteSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Parasite FAQs found for:', movie?.Title);
        return null;
    }
...
export default ParasiteSEOFAQSection;
