// components/BasicInstinctSEOFAQSection.js - MATCHING EROTIC THRILLER THEME ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Flame } from 'lucide-react'; // 🔥 Swapped to Flame for the Erotic Thriller theme

// 🔥 IMPORT THE NEW DYNAMIC FAQ GENERATOR
import { COMPLETE_MOVIE_DATA as BASIC_INSTINCT_MOVIE_DATA, getVisibleMovieFAQs } from '../utils/basicInstinctMovieData';

const BasicInstinctSEOFAQSection = ({ movie }) => {
    const movieInfo = BASIC_INSTINCT_MOVIE_DATA[movie?.tmdbId];
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Basic Instinct FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie?.Title} and its exploration of psychological manipulation, neo-noir themes, and erotic suspense.
            </p>
...
export default BasicInstinctSEOFAQSection;