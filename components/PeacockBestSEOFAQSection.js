// components/PeacockBestSEOFAQSection.js - PEACOCK BEST MOVIES THEME (GOLD) ✅
...
const PeacockBestSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Peacock Best FAQs found for:', movie?.Title);
        return null;
    }
...
export default PeacockBestSEOFAQSection;
