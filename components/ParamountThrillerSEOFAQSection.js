// components/ParamountThrillerSEOFAQSection.js - MATCHING PARAMOUNT+ THRILLER DESIGN (Red/Slate Theme) ✅
...
const ParamountThrillerSEOFAQSection = ({ movie }) => {
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Paramount+ Thriller FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie.Title} and its impact on the psychological thriller genre.
            </p>
...
export default ParamountThrillerSEOFAQSection;