// components/MonicaBellucciSEOFAQSection.js - MATCHING CINEMATIC ALLURE THEME ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Film } from 'lucide-react'; // 🎬 Swapped to Film for the International Cinema theme

// 🔥 IMPORT THE NEW DYNAMIC FAQ GENERATOR
import { COMPLETE_MOVIE_DATA as MONICA_BELLUCCI_MOVIE_DATA, getVisibleMovieFAQs } from '../utils/monicaBellucciMovieData';

const MonicaBellucciSEOFAQSection = ({ movie }) => {
    const movieInfo = MONICA_BELLUCCI_MOVIE_DATA[movie?.tmdbId];
    ...
    if (!faqsFromData || faqsFromData.length === 0) {
        console.log('⚠️ No Monica Bellucci FAQs found for:', movie?.Title);
        return null;
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base">
                Common questions about {movie?.Title}, exploring Monica Bellucci's profound dramatic range, historic roles, and cinematic impact.
            </p>
...
export default MonicaBellucciSEOFAQSection;