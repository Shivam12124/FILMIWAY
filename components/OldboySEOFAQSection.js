// components/OldboySEOFAQSection.js - ✅ FIXED VERSION
import React from 'react';
import { motion } from 'framer-motion';
import { Info } from 'lucide-react';
import { COMPLETE_MOVIE_DATA as OLDBOY_MOVIE_DATA, OLDBOY_MOVIE_FAQS } from '../utils/oldboyMovieData';

const OldboySEOFAQSection = ({ movie }) => {
    const faqsFromData = movie?.Title && OLDBOY_MOVIE_FAQS?.[movie.Title] 
        ? OLDBOY_MOVIE_FAQS[movie.Title] 
        : [];
    ...
    return (
        <motion.section className="mt-12 sm:mt-16 pt-6 sm:pt-8 border-t border-gray-700/50">
...
export default OldboySEOFAQSection;  // ✅ CRITICAL LINE
