// components/HuluHorrorSEOFAQSection.js - DYNAMIC & SEO OPTIMIZED ✅
import React from 'react';
import { motion } from 'framer-motion';
import { Skull } from 'lucide-react'; // Matches the Horror vibe
// 🔥 IMPORT THE DYNAMIC FAQ GENERATOR
import { getVisibleMovieFAQs } from '../utils/huluHorrorMovieData';

const HuluHorrorSEOFAQSection = ({ movie }) => {
    ...
    return (
        ...
        >
            {/* 🎨 Blood Red/Darkness Theme for the Horror Collection */}
            ...
            <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
                Explore our **Parents Guide** and expert analysis for {title}. We provide accurate timestamps for sensitive scenes to skip and map the biggest trauma peaks of this Hulu horror hit.
            </p>
            ...
            <div className="space-y-4 sm:space-y-6">
                {faqsFromData.map((faq, index) => (
                    <motion.div 
                        key={index}
                        className="bg-gray-800/30 rounded-xl p-4 sm:p-6 border border-gray-700/50 hover:border-red-600/30 transition-colors duration-300 group"
...
export default HuluHorrorSEOFAQSection;