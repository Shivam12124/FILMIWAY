  ...
  return (
    <>
      ...
      <div className="relative min-h-screen bg-[#030303] text-white font-sans overflow-x-hidden selection:bg-yellow-500/30 selection:text-yellow-200">
        ...
        <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-24">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
            ...
            >
              {/* HERO BADGES */}
              <div className="flex flex-wrap items-center justify-center gap-3.5 mb-8 pt-0" suppressHydrationWarning>
