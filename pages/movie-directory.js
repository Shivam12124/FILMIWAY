...
import { COMPLETE_MOVIE_DATABASE as ENEMIES_TO_LOVERS_DATABASE } from '../utils/enemiesToLoversMovieData';
import { COMPLETE_MOVIE_DATABASE as JLAW_DATABASE } from '../utils/jenniferLawrenceMovieData';
import { COMPLETE_MOVIE_DATABASE as MONICA_BELLUCCI_DATABASE } from '../utils/monicaBellucciMovieData';
...
export async function getStaticProps() {
  const allDbs = [
    ...
    A24_DATABASE, DARK_COMEDY_DATABASE, PTA_DATABASE, BASIC_INSTINCT_DATABASE, ENEMIES_TO_LOVERS_DATABASE, JLAW_DATABASE, MONICA_BELLUCCI_DATABASE, HULU_FAMILY_DATABASE, HBO_ACTION_DATABASE, HBO_MAX_ROMANCE_DATABASE, HBO_MAX_THRILLER_DATABASE,
