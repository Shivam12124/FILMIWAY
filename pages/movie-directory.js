...
export async function getStaticProps() {
  const allDbs = [
    ...
    A24_DATABASE, DARK_COMEDY_DATABASE, PTA_DATABASE, BASIC_INSTINCT_DATABASE, ENEMIES_TO_LOVERS_DATABASE, HULU_FAMILY_DATABASE, HBO_ACTION_DATABASE, HBO_MAX_ROMANCE_DATABASE, HBO_MAX_THRILLER_DATABASE,
