      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-28">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/collection/movies-like-inception"
              className="text-gray-300 hover:text-white transition-colors text-lg"
            >
              Collections
            </Link>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Search for movies, discover new films, and explore cinema across all genres on Filmiway - Where Every Film Finds Its Way."
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Search and discover amazing movies across every genre and era',
                ...
                >
                  ...
                  {searchResults.length > 0 ? (
                    ...
                    >
                      ...
                      <h3 className="text-2xl font-light text-gray-400 mb-4">
                        No movies found
                      </h3>
