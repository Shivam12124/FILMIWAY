// pages/collection/best-family-movies-on-peacock/[id].js - PEACOCK FAMILY MOVIES ✅
...
// ✅ IMPORT PEACOCK FAMILY DATA & SCHEMA GENERATOR
import {
...
// ✅ RENAMED TO PEACOCK FAMILY
const PeacockFamilyMoviePage = ({ movie, tmdbData: movieData, sensitiveData }) => {
  ...
  const collectionSlug = 'best-family-movies-on-peacock';
  const dynamicCollectionName = 'Best Family Movies on Peacock';
      ...
      <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
          ...
          <div className="relative z-10 pt-10 sm:pt-12 lg:pt-16">
              ...
              <div className="container mx-auto px-0 pb-16 sm:pb-24 lg:pb-32 max-w-7xl">
                  ...
                  >
                      {/* ✅ Passing Peacock Family Context and sensitiveData */}
                      <MovieDetailsSection 
                          movie={movie} 
                          fromPeacockFamilyCollection={true} 
