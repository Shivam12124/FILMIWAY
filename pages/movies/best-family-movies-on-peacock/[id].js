...
const PeacockFamilyMoviePage = ({ movie, tmdbData: movieData }) => {
  ...
  useEffect(() => {
    ...
    const cleanSEOTitle = [movie.Title, ' (', currentMovieYear, ') - Best Family Movies on Peacock | Filmiway'].join('');
    const cleanSEODesc = [movie.Title, ' (', currentMovieYear, ') - A wonderful family movie streaming on Peacock. Ranked by wholesomeness and fun factor.'].join('');
