...
const HboFamilyMoviePage = ({ movie, tmdbData: movieData }) => {
  ...
  useEffect(() => {
    ...
    const cleanSEOTitle = [movie.Title, ' (', currentMovieYear, ') - Best Family Movies on HBO Max | Filmiway'].join('');
    const cleanSEODesc = [movie.Title, ' (', currentMovieYear, ') - A magical family movie streaming on HBO Max. Ranked by wholesomeness and fun factor.'].join('');
