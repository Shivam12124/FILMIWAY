...
const PeacockComedyMoviePage = ({ movie, tmdbData: movieData, sensitiveData }) => {
  ...
  useEffect(() => {
    ...
    const collectionSlug = 'best-comedy-movies-on-peacock';
    const dynamicCollectionName = 'Best Comedy Movies on Peacock';
        ...
        <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
            ...
            <div className="relative z-10 pt-10 sm:pt-12 lg:pt-16">
                ...
                <div className="container mx-auto px-0 pb-16 sm:pb-24 lg:pb-32 max-w-7xl">
                    ...
                    >
                        {/* ✅ Passing context flag and sensitive data */}
                        <MovieDetailsSection 
                            movie={movie} 
                            fromPeacockComedyCollection={true} 
