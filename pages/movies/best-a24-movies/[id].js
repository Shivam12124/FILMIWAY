...
// ✅ PERFECT ALIGNMENT: Rotated Chevron + Placed exactly like A24 file
const MysteryBreadcrumb = ({ movie }) => (
    <motion.nav className="mb-6 sm:mb-8 px-3 sm:px-4 lg:px-6 pb-3 sm:pb-4" style={{ borderBottom: `1px solid ${COLORS.borderLight}` }} initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm" style={{ color: COLORS.textMuted }}>
            ...
            {/* Added transform: 'rotate(180deg)' so it points forward > */}
  ...
  const { movieSchema, faqSchema } = generateCleanMovieSchema(
    ...
    return (
        <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
            <Head>
                {/* ✅ HYDRATION BUG FULLY RESOLVED: Clean String Outputs */}
          ...
          <Header />
            ...
            {/* ✅ FIXED CLEARANCE (pt-20 sm:pt-24 lg:pt-28) to stop header overlap */}
            <div className="relative z-10 pt-20 sm:pt-24 lg:pt-28">
                <h1 className="sr-only">{cleanSEOTitle}</h1>

                {/* ✅ PLACED OUTSIDE THE MAX-W CONTAINER LIKE A24 */}
                ...
                <div className="container mx-auto px-0 pb-16 sm:pb-24 lg:pb-32 max-w-7xl">
                    ...
                    <motion.div id="watch" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="space-y-8 sm:space-y-12 px-3 sm:px-4 lg:px-6 mt-8">
                         <MovieDetailsSection movie={movie} fromMysteryThrillerCollection={true} />
                    </motion.div>
                         
                    <div className="px-3 sm:px-4 lg:px-6 border-t border-gray-800 pt-8 mt-12">
