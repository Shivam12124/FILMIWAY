// pages/movies/best-sci-fi-movies-on-hbo-max/[id].js
// HBO MAX SCI-FI MOVIES COLLECTION
...
const MOVIE_DATA_BY_TITLE = {
    ...
    'Dune: Part Two': { connection: 'A massive, mythic war epic. It fulfills the promise of the first film, delivering a sensory overload of sand, spice, and destiny.' },
    'Stalker': { connection: 'A hypnotic, philosophical journey. It explores the terrifying potential of a place where your deepest, darkest wishes actually come true.' },
    'Dune': { connection: 'The foundation of modern sci-fi epics. It balances intricate political intrigue with a tangible, gritty sense of alien ecology.' },
...
const OptimizedBanner = ({ movie, movieData, trailer, isMobile, richData }) => {
    ...
    // ✅ DATA MAPPING: Use 'spectacularLevel' for HBO Max Sci-Fi
                        ...
                        <motion.div className="flex-1 w-full min-w-0" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.0, duration: 0.8 }}>
                            <motion.div className="relative rounded-xl sm:rounded-2xl overflow-hidden p-4 sm:p-6 lg:p-8 backdrop-blur-sm" style={{ background: `linear-gradient(135deg, rgba(14, 165, 233, 0.15) 0%, rgba(15, 15, 20, 0.5) 100%)`, border: `1px solid ${COLORS.borderLight}`, boxShadow: `0 8px 32px rgba(14, 165, 233, 0.2)` }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1, duration: 0.8 }}>
                                ...
                                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
                                    ...
                                    <div className="min-w-0 flex-1"><h2 className="text-sm sm:text-base lg:text-xl xl:text-2xl font-bold leading-tight" style={{ color: COLORS.accent }}>Cosmic Scale</h2><p className="text-xs sm:text-sm hidden sm:block" style={{ color: COLORS.textMuted }}>Spectacular Level: {spectacularLevel}/100</p></div>
                                </div>
        ...
        <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
            ...
            <div className="relative z-10 pt-10 sm:pt-12 lg:pt-16">
                ...
                <div className="container mx-auto px-0 pb-16 sm:pb-24 lg:pb-32 max-w-7xl">
                    ...
                    >
                        {/* ✅ Passing HBO Max Sci-Fi context */}
