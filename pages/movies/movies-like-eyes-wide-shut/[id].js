...
const EyesWideShutMoviePage = ({ movie, tmdbData: movieData }) => {
  ...
  const collectionSlug = 'movies-like-eyes-wide-shut';
  const collectionShortTag = 'Surreal'; // Short, unique tag for this collection
  ...
  if (scenes.length > 0) {
    // Ideal: Timestamps & Parents Guide: The Game (1997) - Surreal
