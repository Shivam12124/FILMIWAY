...
const ParamountActionMoviePage = ({ movie, tmdbData: movieData, sensitiveData }) => {
  ...
  const collectionSlug = 'best-action-movies-on-paramount-plus';
  const dynamicCollectionName = 'Best Action Movies on Paramount+';
          ...
          <div className="relative z-10 pt-10 sm:pt-12 lg:pt-16">
              ...
              <div className="container mx-auto px-0 pb-16 sm:pb-24 lg:pb-32 max-w-7xl">
                  ...
                  >
                      ...
                      <MovieDetailsSection 
                          movie={movie} 
                          fromParamountActionCollection={true} 
