...
const MysteryThrillerMoviePage = ({ movie, tmdbData: movieData }) => {
  ...
  useEffect(() => {
    ...
    const routeSlug = 'mystery-thriller'; // Exact Next.js folder name
    const collectionShortTag = 'Twist'; // Short, unique tag for this collection
    ...
    if (scenes.length > 0) {
      // Ideal: Timestamps & Parents Guide: Gone Girl (2014) - Twist
