// pages/movies/like-memento/[id].js - MOBILE-OPTIMIZED VERSION ✅
import React, { useState, useEffect, useRef } from 'react';
import Head from 'next/head';
import Link from 'next/link';
import Image from 'next/image';
import { motion, AnimatePresence } from 'framer-motion';
import { ChevronLeft, ChevronRight, Play, X, Zap, User, Twitter, Hash, Send } from 'lucide-react';
...
const MementoMoviePage = ({ movie }) => {
    ...
    return (
        <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
            <Head>
  <title>{movie.Title} ({currentMovieYear}) - Movies Like Memento | Filmiway</title>
  <meta name="description" content={`${movie.Title} (${currentMovieYear}) - A compelling memory-loss thriller like Memento. Analysis, ratings & where to stream.`} />
  ...
  {/* Open Graph */}
  <meta property="og:title" content={`${movie.Title} (${currentMovieYear}) - Like Memento`} />
  <meta property="og:description" content={`A compelling memory-loss thriller similar to Memento`} />
  ...
  <meta name="twitter:description" content={`A memory-loss thriller like Memento`} />
