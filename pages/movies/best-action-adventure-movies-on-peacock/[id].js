...
// ✅ IMPORT PEACOCK ACTION & ADVENTURE DATA & SCHEMA GENERATOR
import { 
...
const PeacockActionAdventureMoviePage = ({ movie, tmdbData: movieData }) => {
  ...
  const collectionSlug = 'best-action-adventure-movies-on-peacock';
  const dynamicCollectionName = 'Peacock Planet: Top 10 Action & Adventure';
  ...
  if (scenes.length > 0) {
      ...
      cleanSEODesc = `Parents Guide for ${movie.Title} (${currentMovieYear}). Filmiway Timestamps & Parents Guide: No explicit sexual content or severe violence identified. Suitable for general viewing.`;
  }
      ...
      <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
          ...
          <div className="relative z-10 pt-10 sm:pt-12 lg:pt-16">
              ...
              <div className="container mx-auto px-0 pb-16 sm:pb-24 lg:pb-32 max-w-7xl">
                  ...
                  >
                      {/* ✅ FIX: Moved the MovieDetailsSection safely inside the parent div! */}
                      <MovieDetailsSection movie={movie} fromPeacockActionAdventureCollection={true} />
                  </motion.div>
