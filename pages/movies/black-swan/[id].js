// pages/movies/black-swan/[id].js - H1 SEO FIX + HYDRATION COMMENT REMOVAL ✅
...
const BlackSwanMoviePage = ({ movie, tmdbData: movieData }) => {
  ...
  const collectionShortTag = 'Obsession'; // Short, unique tag for this collection
  ...
  if (scenes.length > 0) {
    // Ideal: Timestamps & Parents Guide: Perfect Blue (1997) - Obsession
