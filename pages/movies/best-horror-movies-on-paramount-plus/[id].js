...
const generateMovieSchema = (movie, movieData, currentMovieYear) => {
  ...
  const movieSchema = {
    ...
    "url": `https://filmiway.com/collection/best-horror-movies-on-paramount-plus/${movie.imdbID}`,
    "author": {
      "@type": "Organization",
      "name": "Filmiway",
    ...
    return (
        <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: COLORS.bgPrimary }}>
            <Head>
                ...
                <link rel="canonical" href={`https://filmiway.com/collection/best-horror-movies-on-paramount-plus/${movie.imdbID}`} />
