...
const VERIFIED_PARENTS_GUIDE_IDS = new Set([
    ...
    '293660', 'tt1431045', // Deadpool (2016)
    '46705', 'tt1120985', // Blue Valentine (2010)
    '491584', 'tt7282468', // Burning (2018)
    '744857', 'tt16300962', // When Evil Lurks (2023)
    '1813', 'tt0118971', // The Devil's Advocate (1997)
    ...
    '44214', '670', '64690', '11423', '861', '10843', '5915', '97370', '28', '341174', '1368166', '9303'
]);
    ...
    const movieSchema = {
        ...
        "review": movie.safetyScore ? {
            ...
            "reviewRating": {
                ...
                "bestRating": "10",
                "worstRating": "1",
                "ratingExplanation": `Family Safety Score: ${movie.safetyLabel}. ${movie.safetyDesc}`
            },
...
export async function getStaticProps({ params }) {
    ...
    // 🗓️ DETERMINISTIC FRESHNESS DATE: August 22, 2026 ONLY for updated movies (Wild Things & Obsession)
    const augDates = [
        "August 1, 2026",
        "August 2, 2026",
        "August 3, 2026",
