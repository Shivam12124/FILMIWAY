...
export const HBO_SCIFI_MOVIE_FAQS = {
    ...
    'Mickey 17': [
        { question: "Does Mickey 17 have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Mickey 17 is rated as Moderate. Moderate to strong violence including amputations, bloody vomiting, chainsaw mutilation, burnings, creature attacks, disturbing body horror, gore, and repeated scenes of brutal injury detail." },
        { question: "Does Mickey 17 have profanity or swearing?", answer: "The profanity in Mickey 17 is rated as Moderate. Moderate to strong language throughout including 50+ uses of the F-word, repeated crude language, sexual references, insults, and frequent mild profanity." },
        { question: "Why is Mickey 17 rated 16+?", answer: "Mickey 17 earns its 16+ rating for moderate violence, brief nudity, and moderate language. Specifically, the film contains: Moderate to strong violence including amputations, bloody vomiting, chainsaw mutilation, burnings, creature attacks, disturbing body horror, gore, and repeated scenes of brutal injury detail. Moderate to strong language throughout including 50+ uses of the F-word, repeated crude language, sexual references, insults, and frequent mild profanity. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = HBO_SCIFI_MOVIE_FAQS[movie.Title] ? [...HBO_SCIFI_MOVIE_FAQS[movie.Title]] : [];
