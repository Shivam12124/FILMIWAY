...
export const NEO_NOIR_FAQS = {
    'Chinatown': [
        { question: "Does Chinatown have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Chinatown is rated as Moderate. Moderate bloody violence including graphic murder aftermaths, brutal fist fights, shootings, facial injuries, and disturbing corpse imagery." },
        { question: "Does Chinatown have profanity or swearing?", answer: "The profanity in Chinatown is rated as Mild. Mild-to-moderate language including infrequent use of the F-word, sexual jokes, crude terms, and occasional derogatory language." },
        { question: "Why is Chinatown rated 16+?", answer: "Chinatown earns its 16+ rating for moderate violence, explicit sex and  nudity, and mild language. Specifically, the film contains: Moderate bloody violence including graphic murder aftermaths, brutal fist fights, shootings, facial injuries, and disturbing corpse imagery. Mild-to-moderate language including infrequent use of the F-word, sexual jokes, crude terms, and occasional derogatory language. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'After Hours': [
        { question: "Does After Hours have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in After Hours is rated as Mild. Mild disturbing content includes suicide-related themes, animal distress, a non-graphic corpse depiction, brief gun violence with some blood, and unsettling references to violent death." },
        { question: "Does After Hours have profanity or swearing?", answer: "The profanity in After Hours is rated as Mild. Mild to moderate language includes occasional coarse profanity, a few stronger expletives, and a derogatory slur." },
        { question: "Why is After Hours rated 14+?", answer: "After Hours earns its 14+ rating for mild violence, brief nudity, and mild language. Specifically, the film contains: Mild disturbing content includes suicide-related themes, animal distress, a non-graphic corpse depiction, brief gun violence with some blood, and unsettling references to violent death. Mild to moderate language includes occasional coarse profanity, a few stronger expletives, and a derogatory slur. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
