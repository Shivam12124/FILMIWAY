...
export const NEO_NOIR_FAQS = {
    ...
    'Drive': [
        { question: "Does Drive have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Drive is rated as High. Strong, increasingly graphic violence featuring brutal beatings, stabbings, shootings, throat slittings, and bloody injuries. Includes several disturbing gore sequences with head trauma, decapitation, visible brain matter, and frequent bloodshed in the movie." },
        { question: "Does Drive have profanity or swearing?", answer: "The profanity in Drive is rated as High. Frequent strong language, over 30 uses of the F-word, along with repeated moderate profanity, discriminatory slurs, and an obscene hand gesture." },
