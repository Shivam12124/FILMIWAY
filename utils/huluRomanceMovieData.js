...
export const HULU_ROMANCE_MOVIE_FAQS = {
    'Anora': [
        { question: "Does Anora have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Anora is rated as Mild. Mild to moderate violence includes biting, punching, and several physical confrontations involving pushing, grabbing, and restraint. Some characters sustain minor injuries such as bruises, scars, and a black eye, and one woman is briefly restrained and tied up." },
        { question: "Does Anora have profanity or swearing?", answer: "The profanity in Anora is rated as High. Very strong language throughout, including extremely frequent use of the F-word (over 500 uses), repeated coarse profanity, sexualized insults, degrading slurs, and occasional highly offensive language." },
        { question: "Why is Anora rated 18+?", answer: "Anora earns its 18+ rating for mild violence, explicit sex and heavy nudity, and strong language throughout. Specifically, the film contains: Mild to moderate violence includes biting, punching, and several physical confrontations involving pushing, grabbing, and restraint. Some characters sustain minor injuries such as bruises, scars, and a black eye, and one woman is briefly restrained and tied up. Very strong language throughout, including extremely frequent use of the F-word (over 500 uses), repeated coarse profanity, sexualized insults, degrading slurs, and occasional highly offensive language. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
        { 
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = HULU_ROMANCE_MOVIE_FAQS[movie.Title] ? [...HULU_ROMANCE_MOVIE_FAQS[movie.Title]] : [];
