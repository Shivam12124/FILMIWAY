...
export const TMDB_CONFIG = {
      API_KEY: 'process.env.NEXT_PUBLIC_TMDB_API_KEY', // Replace with your actual key
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = PEACOCK_ACTION_ADVENTURE_FAQS[movie.Title] ? [...PEACOCK_ACTION_ADVENTURE_FAQS[movie.Title]] : [];
