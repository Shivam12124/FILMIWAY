...
export const HULU_ACTION_MOVIE_FAQS = {
    ...
    'Bullet Train': [
        ...
        { question: "Why is Bullet Train rated 16+?", answer: "Bullet Train earns its 16+ rating for brutal graphic violence and strong language throughout. Specifically, the film contains: Intense action violence throughout, featuring frequent gunfights and sword combat with many bloody deaths including slashing, impalement, and gunshot injuries. Includes brief dismemberment imagery and disturbing body disposal scenes. Strong language throughout, including over 100 uses of the F-word and variations, frequent coarse profanity, and extensive insulting and sexualized language. The dialogue also includes repeated scatological and mild obscenities." },
        { 
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = HULU_ACTION_MOVIE_FAQS[movie.Title] ? [...HULU_ACTION_MOVIE_FAQS[movie.Title]] : [];
...
export const getVisibleMovieFAQs = (movieTitle, tmdbId, currentRuntime = "Official") => {
    const staticFaqs = HULU_ACTION_MOVIE_FAQS[movieTitle] ? [...HULU_ACTION_MOVIE_FAQS[movieTitle]] : [];
