...
export const INCEPTION_COLLECTION_FAQS = {
    ...
    'Mulholland Drive': [
        { question: "Does Mulholland Drive have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Mulholland Drive is rated as Moderate. Moderate violence including shootings, a suicide scene, disturbing corpse imagery, car crash injuries, and brief bloody injury detail." },
        { question: "Does Mulholland Drive have profanity or swearing?", answer: "The profanity in Mulholland Drive is rated as Mild. Mild language with occasional use of the F-word and infrequent coarse terms." },
        { question: "Why is Mulholland Drive rated 16+?", answer: "Mulholland Drive earns its 16+ rating for moderate violence, nudity, and mild language. Specifically, the film contains: Moderate violence including shootings, a suicide scene, disturbing corpse imagery, car crash injuries, and brief bloody injury detail. Mild language with occasional use of the F-word and infrequent coarse terms. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Coherence': [
        { question: "Does Coherence have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Coherence is rated as Mild. Mild to moderate violence includes brief physical assaults such as attempted strangulation, striking with a blunt household object, a restrained character shown tied to a chair, repeated hitting, and a minor head injury." },
        { question: "Does Coherence have profanity or swearing?", answer: "The profanity in Coherence is rated as Moderate. Strong language throughout, including over 20 uses of the F-word alongside frequent coarse profanity and occasional mild obscenities." },
        { question: "Why is Coherence rated 14+?", answer: "Coherence earns its 14+ rating for mild violence and strong language. Specifically, the film contains: Mild to moderate violence includes brief physical assaults such as attempted strangulation, striking with a blunt household object, a restrained character shown tied to a chair, repeated hitting, and a minor head injury. Strong language throughout, including over 20 uses of the F-word alongside frequent coarse profanity and occasional mild obscenities." },
    ...
    'The Usual Suspects': [
        { question: "Does The Usual Suspects have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Usual Suspects is rated as Moderate. Strong violence includes frequent shootings, bloody aftermath scenes, and disturbing injury detail such as burned bodies and visible corpses. The film also contains a highly disturbing sequence involving sexual assault, family murder, and self-inflicted death, along with sustained threat and discussion of violence throughout." },
        { question: "Does The Usual Suspects have profanity or swearing?", answer: "The profanity in The Usual Suspects is rated as High. Strong language throughout, including frequent use of the F-word, repeated coarse, and a few highly offensive slurs and vulgar insults." },
        { question: "Why is The Usual Suspects rated 16+?", answer: "The Usual Suspects earns its 16+ rating for moderate violence, minor sexual content, and strong language throughout. Specifically, the film contains: Strong violence includes frequent shootings, bloody aftermath scenes, and disturbing injury detail such as burned bodies and visible corpses. The film also contains a highly disturbing sequence involving sexual assault, family murder, and self-inflicted death, along with sustained threat and discussion of violence throughout. Strong language throughout, including frequent use of the F-word, repeated coarse, and a few highly offensive slurs and vulgar insults. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
