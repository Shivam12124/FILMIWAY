...
export const EYES_WIDE_SHUT_MOVIE_FAQS = { 
    ...
    'The Game': [
        { question: "Does The Game have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Game is rated as Mild. Mild to moderate violence and disturbing content includes a suicide attempt, an implied suicide witnessed by a child, intense drowning peril, and several scenes of gun violence with some blood and uncertain fatalities." },
        { question: "Does The Game have profanity or swearing?", answer: "The profanity in The Game is rated as Moderate. Strong language throughout, including 30+ uses of the F-word alongside frequent coarse profanity, occasional crude body-part references, and multiple mild obscenities." },
        { question: "Why is The Game rated 14+?", answer: "The Game earns its 14+ rating for mild violence, minor sexual content, and strong language. Specifically, the film contains: Mild to moderate violence and disturbing content includes a suicide attempt, an implied suicide witnessed by a child, intense drowning peril, and several scenes of gun violence with some blood and uncertain fatalities. Strong language throughout, including 30+ uses of the F-word alongside frequent coarse profanity, occasional crude body-part references, and multiple mild obscenities. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'The Killing of a Sacred Deer': [
        { question: "Does The Killing of a Sacred Deer have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Killing of a Sacred Deer is rated as Moderate. Strong disturbing violence and psychological threat throughout, including violence against children, scenes of physical abuse, visible blood injury detail, and several unsettling graphic moments such as open-heart surgery imagery and self-inflicted injury. The film also features intense life-threatening scenarios involving a forced deadly game." },
        { question: "Does The Killing of a Sacred Deer have profanity or swearing?", answer: "The profanity in The Killing of a Sacred Deer is rated as Moderate. Moderate language includes occasional use of coarse profanity, with a few uses of the F-word alongside other mild to moderate swear words." },
        { question: "Why is The Killing of a Sacred Deer rated 16+?", answer: "The Killing of a Sacred Deer earns its 16+ rating for moderate violence, explicit sex and brief nudity, and moderate language. Specifically, the film contains: Strong disturbing violence and psychological threat throughout, including violence against children, scenes of physical abuse, visible blood injury detail, and several unsettling graphic moments such as open-heart surgery imagery and self-inflicted injury. The film also features intense life-threatening scenarios involving a forced deadly game. Moderate language includes occasional use of coarse profanity, with a few uses of the F-word alongside other mild to moderate swear words. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
