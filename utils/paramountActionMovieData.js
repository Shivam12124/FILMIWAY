...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const movieSchema = {
        ...
        '@type': 'Movie',
        'name': movie.Title,
        'description': movieInfo?.synopsis || `${movie.Title} (${currentMovieYear}) - High octane action movie on Paramount+.`,
        'genre': movie.genre,
    ...
    const staticFaqs = PARAMOUNT_ACTION_MOVIE_FAQS[movie.Title] || [];
...
export const getVisibleMovieFAQs = (movieTitle, tmdbId, currentRuntime = "Official") => {
    const staticFaqs = PARAMOUNT_ACTION_MOVIE_FAQS[movieTitle] ? [...PARAMOUNT_ACTION_MOVIE_FAQS[movieTitle]] : [];
