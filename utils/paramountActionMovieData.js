...
export const TMDB_CONFIG = {
      API_KEY: 'process.env.NEXT_PUBLIC_TMDB_API_KEY', // Replace with your actual key if needed
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = PARAMOUNT_ACTION_MOVIE_FAQS[movie.Title] ? [...PARAMOUNT_ACTION_MOVIE_FAQS[movie.Title]] : [];
