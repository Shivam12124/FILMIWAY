...
export const PEACOCK_ROMANCE_MOVIE_FAQS = {
  ...
  'Challengers': [
        ...
        { question: "Why is Challengers rated 16+?", answer: "Challengers earns its 16+ rating for mild violence, nudity and minor sexual content, and strong language throughout. Specifically, the film contains: Mild to moderate sports-related violence includes an on-court knee injury with a visible snap and later brace use, along with brief physical altercations such as slapping, pushing, and a groin hit. The film also contains frequent heated arguments, aggressive behavior during tennis matches, and moments of emotional distress, but no serious or graphic violence beyond the injury scene. Strong language throughout, including over 50 uses of the F-word and its derivatives, along with occasional sexual references, mild obscenities, and name-calling. The dialogue also includes a few scatological terms and an isolated obscene gesture, plus frequent heated exchanges and exclamations. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = PEACOCK_ROMANCE_MOVIE_FAQS[movie.Title] ? [...PEACOCK_ROMANCE_MOVIE_FAQS[movie.Title]] : [];
