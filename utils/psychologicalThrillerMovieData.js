...
export const PSYCH_THRILLER_FAQS = {
    'The Silence of the Lambs': [
        { question: "Does The Silence of the Lambs have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Silence of the Lambs is rated as High. Disturbing psychological violence including cannibalism references, graphic corpse imagery, autopsies, mutilation, bloody murders, and intense scenes of kidnapping and torture themes." },
        { question: "Does The Silence of the Lambs have profanity or swearing?", answer: "The profanity in The Silence of the Lambs is rated as Moderate. Strong language including multiple F-words, use of the C-word, sexual profanity, and repeated moderate coarse language." },
        { question: "Why is The Silence of the Lambs rated 16+?", answer: "The Silence of the Lambs earns its 16+ rating for brutal graphic violence, brief nudity and minor sexual content, and moderate language. Specifically, the film contains: Disturbing psychological violence including cannibalism references, graphic corpse imagery, autopsies, mutilation, bloody murders, and intense scenes of kidnapping and torture themes. Strong language including multiple F-words, use of the C-word, sexual profanity, and repeated moderate coarse language. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Black Swan': [
        { question: "Does Black Swan have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Black Swan is rated as High. Strong disturbing content throughout, including themes of mental breakdown, suicide, and self-harm. Includes hallucinations with body injury imagery, brief violence with some blood, and intense physical strain on dancers, alongside a consistently tense and unsettling tone." },
        { question: "Does Black Swan have profanity or swearing?", answer: "The profanity in Black Swan is rated as Moderate. Strong language throughout, including around 16 uses of the F-word alongside repeated coarse profanity, sexual references, and occasional vulgar insults." },
        { question: "Why is Black Swan rated 16+?", answer: "Black Swan earns its 16+ rating for brutal graphic violence, explicit sex, and moderate language. Specifically, the film contains: Strong disturbing content throughout, including themes of mental breakdown, suicide, and self-harm. Includes hallucinations with body injury imagery, brief violence with some blood, and intense physical strain on dancers, alongside a consistently tense and unsettling tone. Strong language throughout, including around 16 uses of the F-word alongside repeated coarse profanity, sexual references, and occasional vulgar insults. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Oldboy': [
        { question: "Does Oldboy have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Oldboy is rated as High. Strong brutal violence throughout featuring graphic torture, realistic hand-to-hand combat, bloody self-harm and suicide imagery, tooth extraction, stabbing, severed body parts, and disturbing mutilation." },
        { question: "Does Oldboy have profanity or swearing?", answer: "The profanity in Oldboy is rated as Moderate. Strong language throughout includes frequent use of the F-word, scatological profanity, vulgar body-part references, and repeated moderate profanity." },
        { question: "Why is Oldboy rated 18+?", answer: "Oldboy earns its 18+ rating for brutal graphic violence, explicit sex and  nudity, and moderate language. Specifically, the film contains: Strong brutal violence throughout featuring graphic torture, realistic hand-to-hand combat, bloody self-harm and suicide imagery, tooth extraction, stabbing, severed body parts, and disturbing mutilation. Strong language throughout includes frequent use of the F-word, scatological profanity, vulgar body-part references, and repeated moderate profanity. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'The Shining': [
        { question: "Does The Shining have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Shining is rated as High. Strong psychological horror and violence throughout include disturbing corpse imagery, heavy blood visuals, intense violent threats, axe attacks, graphic injury detail, unsettling supernatural imagery, and prolonged scenes of terror, psychological breakdown, and attempted murder." },
        { question: "Does The Shining have profanity or swearing?", answer: "The profanity in The Shining is rated as Moderate. Moderate to strong language includes occasional use of the F-word alongside other coarse profanity, sexual references, and derogatory insults, including a racial slur." },
        { question: "Why is The Shining rated 16+?", answer: "The Shining earns its 16+ rating for brutal graphic violence,  nudity, and moderate language. Specifically, the film contains: Strong psychological horror and violence throughout include disturbing corpse imagery, heavy blood visuals, intense violent threats, axe attacks, graphic injury detail, unsettling supernatural imagery, and prolonged scenes of terror, psychological breakdown, and attempted murder. Moderate to strong language includes occasional use of the F-word alongside other coarse profanity, sexual references, and derogatory insults, including a racial slur. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = PSYCH_THRILLER_FAQS[movie.Title] ? [...PSYCH_THRILLER_FAQS[movie.Title]] : [];
...
export const getVisibleMovieFAQs = (movieTitle, tmdbId, currentRuntime = "Official") => {
    const staticFaqs = PSYCH_THRILLER_FAQS[movieTitle] ? [...PSYCH_THRILLER_FAQS[movieTitle]] : [];
