...
export const THOUGHT_PROVOKING_FAQS = {
    ...
    'Dead Poets Society': [
        { question: "Does Dead Poets Society have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Dead Poets Society is rated as Mild. Moderate violence including fistfights with minor blood, corporal punishment, and a deeply upsetting suicide involving a gunshot." },
        { question: "Does Dead Poets Society have profanity or swearing?", answer: "The profanity in Dead Poets Society is rated as Mild. Mild-to-moderate language including several uses of profanity such as \"shit,\" \"damn,\" \"goddamn,\" and \"hell\"." },
        { question: "Why is Dead Poets Society rated 14+?", answer: "Dead Poets Society earns its 14+ rating for mature themes, mild violence, brief nudity, and mild language. Specifically, the film contains: Moderate violence including fistfights with minor blood, corporal punishment, and a deeply upsetting suicide involving a gunshot. Mild-to-moderate language including several uses of profanity such as \"shit,\" \"damn,\" \"goddamn,\" and \"hell\". The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
