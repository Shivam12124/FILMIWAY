...
export const HULU_BEST_MOVIE_FAQS = {
    ...
    'Hacksaw Ridge': [
        { question: "Does Hacksaw Ridge have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Hacksaw Ridge is rated as High. Extremely graphic war violence throughout, featuring prolonged battle sequences with intense gunfire, explosions, and melee combat, resulting in widespread gore including dismemberment, exposed organs, severe burns, and decaying corpses. The film depicts numerous brutal injuries such as blown-off limbs, headshots with visible brain matter, bayonet and knife wounds, and soldiers burned alive, along with disturbing imagery of mutilated and decomposing bodies on the battlefield." },
        { question: "Does Hacksaw Ridge have profanity or swearing?", answer: "The profanity in Hacksaw Ridge is rated as Moderate. Mild to moderate language includes occasional use of the F-word alongside other coarse profanity, mild expletives, and a racial slur." },
        { question: "Why is Hacksaw Ridge rated 17+?", answer: "Hacksaw Ridge earns its 17+ rating for brutal graphic violence, brief nudity, and moderate language. Specifically, the film contains: Extremely graphic war violence throughout, featuring prolonged battle sequences with intense gunfire, explosions, and melee combat, resulting in widespread gore including dismemberment, exposed organs, severe burns, and decaying corpses. The film depicts numerous brutal injuries such as blown-off limbs, headshots with visible brain matter, bayonet and knife wounds, and soldiers burned alive, along with disturbing imagery of mutilated and decomposing bodies on the battlefield. Mild to moderate language includes occasional use of the F-word alongside other coarse profanity, mild expletives, and a racial slur. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
        { 
