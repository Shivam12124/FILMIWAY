...
export const BLACK_SWAN_MOVIE_FAQS = {
    'Perfect Blue': [
        { question: "Does Perfect Blue have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Perfect Blue is rated as High. Graphic violence involving impalement, eye-gouging, explosions, stabbings, bloody corpses, and disturbing murder imagery throughout." },
        { question: "Does Perfect Blue have profanity or swearing?", answer: "The profanity in Perfect Blue is rated as Moderate. Contains frequent moderate to strong language including repeated uses of the F-word alongside moderate coarse profanity." },
        { question: "Why is Perfect Blue rated 18+?", answer: "Perfect Blue earns its 18+ rating for brutal graphic violence, explicit sex and nudity, and moderate language. Specifically, the film contains: Graphic violence involving impalement, eye-gouging, explosions, stabbings, bloody corpses, and disturbing murder imagery throughout. Contains frequent moderate to strong language including repeated uses of the F-word alongside moderate coarse profanity. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'The Piano Teacher': [
        { question: "Does The Piano Teacher have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Piano Teacher is rated as Moderate. Strong and disturbing content including physical fights, self-harm, and sexual violence, with scenes of assault, blood, and psychologically intense abuse." },
        { question: "Does The Piano Teacher have profanity or swearing?", answer: "The profanity in The Piano Teacher is rated as Moderate. The dialogue features pervasive use of very strong profanity and highly offensive coarse language." },
        { question: "Why is The Piano Teacher rated R?", answer: "The Piano Teacher earns its R rating due to high sexual content and nudity, moderate violence, and moderate profanity. Specifically, the film contains The dialogue features pervasive use of very strong profanity and highly offensive coarse language. Strong and disturbing content including physical fights, self-harm, and sexual violence, with scenes of assault, blood, and psychologically intense abuse. Adults can use our timestamps to skip the explicit content." },
