...
export const GANGSTER_MOVIE_FAQS = { 
    ...
    'Goodfellas': [
        { question: "Does Goodfellas have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Goodfellas is rated as High. Strong graphic violence throughout, featuring brutal beatings, multiple shootings, bloody executions, stabbings, corpse depictions, and several prolonged scenes of realistic and disturbing criminal violence." },
        { question: "Does Goodfellas have profanity or swearing?", answer: "The profanity in Goodfellas is rated as High. Very strong and pervasive coarse language throughout, including 250+ uses of the F-word, repeated highly offensive sexual profanity, derogatory slurs, and frequent vulgar insults." },
        { question: "Why is Goodfellas rated 17+?", answer: "Goodfellas earns its 17+ rating for brutal graphic violence, brief nudity, and strong language throughout. Specifically, the film contains: Strong graphic violence throughout, featuring brutal beatings, multiple shootings, bloody executions, stabbings, corpse depictions, and several prolonged scenes of realistic and disturbing criminal violence. Very strong and pervasive coarse language throughout, including 250+ uses of the F-word, repeated highly offensive sexual profanity, derogatory slurs, and frequent vulgar insults. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Scarface': [
        { question: "Does Scarface have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Scarface is rated as High. Strong bloody violence featuring frequent shootings, graphic gunshot wounds, executions, explosions, riots, and prolonged intense shootouts throughout." },
        { question: "Does Scarface have profanity or swearing?", answer: "The profanity in Scarface is rated as High. Extremely frequent strong language including over 200 uses of the F-word, repeated sexual expletives, coarse insults, and heavy Spanish profanity throughout." },
        { question: "Why is Scarface rated 17+?", answer: "Scarface earns its 17+ rating for brutal graphic violence, brief nudity, and strong language throughout. Specifically, the film contains: Strong bloody violence featuring frequent shootings, graphic gunshot wounds, executions, explosions, riots, and prolonged intense shootouts throughout. Extremely frequent strong language including over 200 uses of the F-word, repeated sexual expletives, coarse insults, and heavy Spanish profanity throughout. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
