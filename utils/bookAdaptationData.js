...
export const BOOK_ADAPTATION_FAQS = { 
    ...
    'The Green Mile': [
        { question: "Does The Green Mile have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Green Mile is rated as High. Strong disturbing violence including graphic executions, prolonged electrocution scenes, bloody shootings, brutal assaults, and disturbing death-related themes." },
        { question: "Does The Green Mile have profanity or swearing?", answer: "The profanity in The Green Mile is rated as Moderate. Strong language including repeated use of the F-word, crude sexual language, racial and homophobic slurs, and frequent coarse profanity throughout." },
        { question: "Why is The Green Mile rated 16+?", answer: "The Green Mile earns its 16+ rating for brutal graphic violence, minor sexual content and brief nudity, and moderate language. Specifically, the film contains: Strong disturbing violence including graphic executions, prolonged electrocution scenes, bloody shootings, brutal assaults, and disturbing death-related themes. Strong language including repeated use of the F-word, crude sexual language, racial and homophobic slurs, and frequent coarse profanity throughout. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
