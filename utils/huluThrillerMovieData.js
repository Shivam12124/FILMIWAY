...
export const HULU_THRILLER_MOVIE_FAQS = {
    ...
    'The Equalizer': [
        { question: "Does The Equalizer have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Equalizer is rated as High. Strong graphic violence throughout, including brutal beatings, shootings, stabbings, torture, and multiple bloody deaths with graphic injury detail. The film features sustained threat, disturbing assaults, and several intensely violent sequences involving heavy bloodshed, close-range kills, and disturbing aftermath imagery." },
        { question: "Does The Equalizer have profanity or swearing?", answer: "The profanity in The Equalizer is rated as High. Strong language throughout, including around 89 uses of the F-word and variations, frequent coarse profanity, mild vulgar references, and repeated insulting language. The dialogue also includes occasional offensive stereotypes and an obscene gesture." },
        { question: "Why is The Equalizer rated 17+?", answer: "The Equalizer earns its 17+ rating for brutal graphic violence, brief nudity, and strong language throughout. Specifically, the film contains: Strong graphic violence throughout, including brutal beatings, shootings, stabbings, torture, and multiple bloody deaths with graphic injury detail. The film features sustained threat, disturbing assaults, and several intensely violent sequences involving heavy bloodshed, close-range kills, and disturbing aftermath imagery. Strong language throughout, including around 89 uses of the F-word and variations, frequent coarse profanity, mild vulgar references, and repeated insulting language. The dialogue also includes occasional offensive stereotypes and an obscene gesture. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = HULU_THRILLER_MOVIE_FAQS[movie.Title] ? [...HULU_THRILLER_MOVIE_FAQS[movie.Title]] : [];
...
export const getVisibleMovieFAQs = (movieTitle, tmdbId, currentRuntime = "Official") => {
    const staticFaqs = HULU_THRILLER_MOVIE_FAQS[movieTitle] ? [...HULU_THRILLER_MOVIE_FAQS[movieTitle]] : [];
