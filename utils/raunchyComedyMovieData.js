...
export const RAUNCHY_COMEDY_FAQS = {
    ...
    'The Hangover': [
        { question: "Does The Hangover have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Hangover is rated as Mild. Mild crude violence includes frequent slapstick fights, punches, taser use, minor injuries with small amounts of blood, reckless driving, and some disturbing but comedic animal-related chaos. Most violence is exaggerated and not graphic." },
        { question: "Does The Hangover have profanity or swearing?", answer: "The profanity in The Hangover is rated as High. Strong language throughout, including over 75 uses of the F-word and variations, frequent sexual references, heavy coarse profanity, and extensive scatological and insulting language. along with a few highly offensive derogatory slurs." },
        { question: "Why is The Hangover rated 16+?", answer: "The Hangover earns its 16+ rating for mild violence, brief nudity, and strong language throughout. Specifically, the film contains: Mild crude violence includes frequent slapstick fights, punches, taser use, minor injuries with small amounts of blood, reckless driving, and some disturbing but comedic animal-related chaos. Most violence is exaggerated and not graphic. Strong language throughout, including over 75 uses of the F-word and variations, frequent sexual references, heavy coarse profanity, and extensive scatological and insulting language. along with a few highly offensive derogatory slurs. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Wedding Crashers': [
        { question: "Does Wedding Crashers have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Wedding Crashers is rated as Mild. Mild comedic violence including punches, minor bloody injuries, rough physical altercations, and brief gross-out vomiting scenes." },
        { question: "Does Wedding Crashers have profanity or swearing?", answer: "The profanity in Wedding Crashers is rated as Moderate. Strong language throughout including 20+ uses of the F-word, repeated crude profanity, sexual slang." },
        { question: "Why is Wedding Crashers rated 16+?", answer: "Wedding Crashers earns its 16+ rating for mild violence, sexual content and  nudity, and moderate language. Specifically, the film contains: Mild comedic violence including punches, minor bloody injuries, rough physical altercations, and brief gross-out vomiting scenes. Strong language throughout including 20+ uses of the F-word, repeated crude profanity, sexual slang. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Deadpool': [
       ...
       { 
         question: "Did Ryan Reynolds really wear the actual Deadpool suit home?", 
            answer: "Ryan Reynolds loved the custom-made suit so much that he walked off the set with it on the final day of filming without asking permission, later stating he felt he had earned it after spending ten years trying to get the movie made." 
        },
    ],
    'Deadpool 2': [
        { question: "Does Deadpool 2 have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Deadpool 2 is rated as High. Strong violence including shootings, explosions, brutal fist fights, prison riots, deadly crashes, and frequent combat sequences with occasional bloody injury detail." },
        { question: "Does Deadpool 2 have profanity or swearing?", answer: "The profanity in Deadpool 2 is rated as High. Pervasive strong language including 100+ uses of the F-word, crude sexual references, obscene gestures, and repeated use of strong profanity throughout." },
        { question: "Why is Deadpool 2 rated 17+?", answer: "Deadpool 2 earns its 17+ rating for brutal graphic violence, brief nudity, and strong language throughout. A mature superhero movie, definitely not for kids. Specifically, the film contains: Strong violence including shootings, explosions, brutal fist fights, prison riots, deadly crashes, and frequent combat sequences with occasional bloody injury detail. Pervasive strong language including 100+ uses of the F-word, crude sexual references, obscene gestures, and repeated use of strong profanity throughout. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
