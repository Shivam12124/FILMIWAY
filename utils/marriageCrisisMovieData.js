...
export const MARRIAGE_CRISIS_MOVIE_FAQS = {
    ...
    'Blue Valentine': [
        { question: "Does Blue Valentine have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Blue Valentine is rated as Mild. Mild physical altercations involving pushing, yelling, and brief striking during emotionally intense confrontations." },
        { question: "Does Blue Valentine have profanity or swearing?", answer: "The profanity in Blue Valentine is rated as High. Frequent strong language including over 30 uses of the F-word alongside repeated crude insults and profanity throughout." },
        { question: "Why is Blue Valentine rated 18+?", answer: "Blue Valentine earns its 18+ rating for explicit sexual intercourse, nudity, and high profanity. Specifically, the film contains: Mild physical altercations involving pushing, yelling, and brief striking during emotionally intense confrontations. Frequent strong language including over 30 uses of the F-word alongside repeated crude insults and profanity throughout. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
