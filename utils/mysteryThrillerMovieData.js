...
export const MYSTERY_THRILLER_FAQS = {
    ...
    'The Invisible Guest': [
        { question: "Does The Invisible Guest have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Invisible Guest is rated as Mild. The film is close to containing no significant violence, with only brief mild moments including a repeated crime scene depiction." },
        { question: "Does The Invisible Guest have profanity or swearing?", answer: "The profanity in The Invisible Guest is rated as Mild. The film is close to containing no strong profanity, with only occasional mild language and infrequent coarse expressions." },
        { question: "Why is The Invisible Guest rated 13+?", answer: "The Invisible Guest earns its 13+ rating for mild violence and mild language. Specifically, the film contains: The film is close to containing no significant violence, with only brief mild moments including a repeated crime scene depiction. The film is close to containing no strong profanity, with only occasional mild language and infrequent coarse expressions." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = MYSTERY_THRILLER_FAQS[movie.Title] ? [...MYSTERY_THRILLER_FAQS[movie.Title]] : [];
