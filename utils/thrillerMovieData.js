...
export const SENSITIVE_TIMELINES = {
  ...
  210577: { 
        scenes: [
            ...
            { start: "20:57", end: "21:02", type: "Sex", severity: "High" },
            { start: "44:21", end: "44:38", type: "Nudity(Woman)", severity: "High" },
...
export const THRILLER_MOVIE_FAQS = {
    ...
    'Gone Girl': [
        { question: "Does Gone Girl have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Gone Girl is rated as High. Features one extremely graphic sequence involving a throat-slitting and significant blood flow. Includes domestic battery and self-inflicted injury." },
        { question: "Does Gone Girl have profanity or swearing?", answer: "The profanity in Gone Girl is rated as High. Pervasive use of strong profanity and graphic sexual language." },
        { question: "Why is Gone Girl rated R?", answer: "Gone Girl earns its R rating due to high sexual content and nudity, high violence, and high profanity. Specifically, the film contains Pervasive use of strong profanity and graphic sexual language. Features one extremely graphic sequence involving a throat-slitting and significant blood flow. Includes domestic battery and self-inflicted injury. Adults can use our timestamps to skip the explicit content." },
