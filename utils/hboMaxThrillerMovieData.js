...
export const HBO_THRILLER_MOVIE_FAQS = {
    ...
    'Fargo': [
        { question: "Does Fargo have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Fargo is rated as High. Strong graphic violence throughout, including multiple shootings, brutal beatings, kidnapping, and several bloody deaths. The film contains disturbing gore, most notably a highly graphic body-disposal scene involving a wood chipper, along with visible blood spray, severe injuries, and sustained threat-related violence." },
        { question: "Does Fargo have profanity or swearing?", answer: "The profanity in Fargo is rated as High. Strong language throughout, including over 70 uses of the F-word alongside repeated coarse profanity and occasional vulgar language." },
        { question: "Why is Fargo rated 17+?", answer: "Fargo earns its 17+ rating for brutal graphic violence, minor sexual content, and strong language throughout. Specifically, the film contains: Strong graphic violence throughout, including multiple shootings, brutal beatings, kidnapping, and several bloody deaths. The film contains disturbing gore, most notably a highly graphic body-disposal scene involving a wood chipper, along with visible blood spray, severe injuries, and sustained threat-related violence. Strong language throughout, including over 70 uses of the F-word alongside repeated coarse profanity and occasional vulgar language. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
        { 
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = HBO_THRILLER_MOVIE_FAQS[movie.Title] ? [...HBO_THRILLER_MOVIE_FAQS[movie.Title]] : [];
