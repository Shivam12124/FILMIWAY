...
export const ROAD_TRIP_MOVIE_FAQS = {
    ...
    'Rain Man': [
        { question: "Does Rain Man have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Rain Man is rated as Mild. Mild comedic violence and distress includes a brief scalding incident with non-graphic injury, a character being shouted at, and some physical reactions played for dramatic/comedic effect, with no lasting harm shown." },
        { question: "Does Rain Man have profanity or swearing?", answer: "The profanity in Rain Man is rated as Moderate. Strong language throughout, primarily from one character in moments of anger, including 15+ uses of the F-word, frequent coarse profanity, multiple uses of \"shit,\" along with an offensive term used in a derogatory context." },
        { question: "Why is Rain Man rated 14+?", answer: "Rain Man earns its 14+ rating for mild violence, brief nudity and minor sexual content, and moderate language. Specifically, the film contains: Mild comedic violence and distress includes a brief scalding incident with non-graphic injury, a character being shouted at, and some physical reactions played for dramatic/comedic effect, with no lasting harm shown. Strong language throughout, primarily from one character in moments of anger, including 15+ uses of the F-word, frequent coarse profanity, multiple uses of \"shit,\" along with an offensive term used in a derogatory context. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
