// utils/detectiveThrillerMovieData.js - 10 BEST DETECTIVE THRILLER COLLECTION ⚡ WITH SENSITIVE CONTENT


export const DETECTIVE_THRILLER_MOVIES = [
  {
    imdbID: 'tt0114369',
    tmdbId: 807,
    title: 'Se7en',
  ...
  },
  {
    ...
    poster_path: '/path/to/secretirs-poster.jpg',
    scenes: [
    ...
    sensitiveScenes: [
      ...
      { start: "1:15:00", end: "1:15:07", description: "Partial nudity (brief exposure of male genitalia)" },
      { start: "1:33:20", end: "1:33:27", description: "Kissing" }
    ]
  },
  {
    imdbID: 'tt0353969',
  ...
  },
  {
    ...
    poster_path: '/path/to/chaser-poster.jpg',
    scenes: [
    ...
    sensitiveScenes: [
      { start: "6:30", end: "7:30", description: "Suggestive clothing" }
    ]
  },
  {
    imdbID: 'tt0327056',
  ...
  },
  {
    ...
    poster_path: '/path/to/marshland-poster.jpg',
    scenes: [
    ...
    sensitiveScenes: [
      ...
      { start: "27:00", end: "27:10", description: "Partial nudity" }
    ]
  },
  {
    imdbID: 'tt0116282',
    ...
    poster_path: '/path/to/fargo-poster.jpg',
    scenes: [
    ...
    sensitiveScenes: [
      { start: "11:45", end: "12:07", description: "Sex" },
      { start: "1:06:48", end: "1:07:42", description: "Sex (brief nudity afterward)" }
    ]
  },
  {
    imdbID: 'tt0106977',
    ...
    poster_path: '/path/to/fugitive-poster.jpg',
    scenes: [
...
export const COMPLETE_DETECTIVE_THRILLER_DATABASE = Object.fromEntries(
  DETECTIVE_THRILLER_MOVIES.map(m => [m.tmdbId, m])
);
