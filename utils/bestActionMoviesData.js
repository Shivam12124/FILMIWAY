    ...
    if (heavyScenes.length > 0) {
        ...
        schemaFaqs.unshift(
            ...
            },
            {
                ...
                'acceptedAnswer': { 
                    '@type': 'Answer', 
                    'text': `Yes, regarding explicit sexual content. Filmiway has confirmed 0 scenes of nudity, sexual content, or explicit scenes in the ${currentRuntime} runtime. (Note: Film may still contain heavy action violence).` 
                }
            }
        );
    }
...
Manually verified frame by frame by Filmiway editors for the ${finalRuntime} runtime.`
        ...
        staticFaqs.unshift(
            ...
            {
                question: `Is ${movieTitle} safe to watch with family?`,
                answer: `Yes, regarding explicit sexual content. Filmiway has confirmed 0 scenes of nudity, sexual content, or explicit scenes in the ${finalRuntime} runtime. (Note: Film may still contain heavy action violence).`
            }
        );
    }
