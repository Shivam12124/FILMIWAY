...
export const BEST_ACTION_MOVIES_FAQS = {
    'Die Hard': [
        { question: "Does Die Hard have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Die Hard is rated as High. Strong bloody action violence throughout, featuring frequent shootouts, gunfights, explosions, and close-range killings. Numerous characters are shot and killed with visible blood effects, including headshots and point-blank executions, along with several brutal hand-to-hand fights involving choking, hanging by the neck, and severe beatings. The film also contains injury detail such as a broken neck, glass-related foot injuries with blood, and bodies being thrown or falling from height, alongside large-scale carnage from explosives and building destruction." },
        { question: "Does Die Hard have profanity or swearing?", answer: "The profanity in Die Hard is rated as High. Strong language throughout, including over 50 uses of the F-word, around 25 uses of the S-word, and frequent additional coarse profanity." },
        { question: "Why is Die Hard rated 16+?", answer: "Die Hard earns its 16+ rating for heavy action violence,  nudity, and strong language throughout. Specifically, the film contains: Strong bloody action violence throughout, featuring frequent shootouts, gunfights, explosions, and close-range killings. Numerous characters are shot and killed with visible blood effects, including headshots and point-blank executions, along with several brutal hand-to-hand fights involving choking, hanging by the neck, and severe beatings. The film also contains injury detail such as a broken neck, glass-related foot injuries with blood, and bodies being thrown or falling from height, alongside large-scale carnage from explosives and building destruction. Strong language throughout, including over 50 uses of the F-word, around 25 uses of the S-word, and frequent additional coarse profanity. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
