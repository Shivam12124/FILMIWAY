...
export const SENSITIVE_TIMELINES = {
    ...
    4960: { // Synecdoche, New York - 6 scenes
        scenes: [
            ...
            { start: timeToSeconds("56:35"), end: timeToSeconds("57:04"), type: "Sex " },
    ...
    206487: { // Predestination - 3 scenes
        scenes: [
            { start: timeToSeconds("19:07"), end: timeToSeconds("19:20"), type: "Sex & Nudity" },
    ...
    181886: { // Enemy - 12 scenes (MOST SENSITIVE)
        scenes: [
            { start: timeToSeconds("1:46"), end: timeToSeconds("1:50"), type: " Nudity " },
    ...
    1381: { // The Fountain - 2 scenes
        scenes: [
            { start: timeToSeconds("26:34"), end: timeToSeconds("27:46"), type: "Nudity" },
            { start: timeToSeconds("36:57"), end: timeToSeconds("37:01"), type: " Nudity " }
        ]
    },
    ...
    31011: { // Mr. Nobody - 6 scenes
        scenes: [
            ...
            { start: timeToSeconds("1:03:58"), end: timeToSeconds("1:05:08"), type: "Intimate Kissing & Nudity" },
            ...
            { start: timeToSeconds("1:35:10"), end: timeToSeconds("1:36:58"), type: "Nudity" }
        ]
    },
