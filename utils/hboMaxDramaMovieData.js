...
export const HBO_DRAMA_MOVIE_FAQS = {
    ...
    'Paris, Texas': [
        { question: "Does Paris, Texas have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Paris, Texas is rated as None. The film contains no actual violence, with no notable violent or graphic content." },
        { question: "Does Paris, Texas have profanity or swearing?", answer: "The profanity in Paris, Texas is rated as Mild. Mild language includes infrequent coarse profanity, with only a couple of stronger expletives." },
        { question: "Why is Paris, Texas rated 13+?", answer: "Paris, Texas earns its 13+ rating for brief nudity and mild language. Specifically, the film contains: The film contains no actual violence, with no notable violent or graphic content. Mild language includes infrequent coarse profanity, with only a couple of stronger expletives. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Joker': [
        { question: "Does Joker have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Joker is rated as High. Strong disturbing violence including shootings, bloody beatings, stabbings, head trauma, and sudden graphic blood spray throughout, with several intense psychologically disturbing scenes." },
        { question: "Does Joker have profanity or swearing?", answer: "The profanity in Joker is rated as Moderate. Moderate to strong language including 20+ uses of the F-word, repeated crude language, obscene gestures, and moderate profanity throughout." },
        { question: "Why is Joker rated 16+?", answer: "Joker earns its 16+ rating for brutal graphic violence, heavy nudity, and moderate language. Specifically, the film contains: Strong disturbing violence including shootings, bloody beatings, stabbings, head trauma, and sudden graphic blood spray throughout, with several intense psychologically disturbing scenes. Moderate to strong language including 20+ uses of the F-word, repeated crude language, obscene gestures, and moderate profanity throughout. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = HBO_DRAMA_MOVIE_FAQS[movie.Title] ? [...HBO_DRAMA_MOVIE_FAQS[movie.Title]] : [];
