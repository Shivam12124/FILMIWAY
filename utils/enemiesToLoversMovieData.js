...
export const ENEMIES_TO_LOVERS_MOVIE_FAQS = {
    ...
    "Anyone But You": [
        { question: "Does Anyone But You have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Anyone But You is rated as None. The film contains no actual violence, with only mild comedic physical incidents and brief non-serious confrontations." },
        { question: "Does Anyone But You have profanity or swearing?", answer: "The profanity in Anyone But You is rated as Moderate. Very strong and frequent coarse language throughout, including 50+ uses of the F-word, repeated strong profanity, highly offensive sexual terms, and other moderate vulgar expressions." },
        { question: "Why is Anyone But You rated R?", answer: "Anyone But You earns its R rating due to high sexual content and nudity, none violence, and moderate profanity. Specifically, the film contains Very strong and frequent coarse language throughout, including 50+ uses of the F-word, repeated strong profanity, highly offensive sexual terms, and other moderate vulgar expressions. The film contains no actual violence, with only mild comedic physical incidents and brief non-serious confrontations. Adults can use our timestamps to skip the explicit content." },
