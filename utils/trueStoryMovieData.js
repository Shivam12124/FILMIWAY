...
export const TRUE_STORY_MOVIE_FAQS = {
    ...
    "Oppenheimer": [
        { question: "Does Oppenheimer have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Oppenheimer is rated as Moderate. Features intense psychological horror, a woman's tragic suicide by sedative overdose and bathtub drowning, and visceral hallucinations of atomic destruction—including skin peeling from a woman's face, stepping on a charred corpse, and harrowing descriptions of the Hiroshima and Nagasaki casualties." },
        { question: "Does Oppenheimer have profanity or swearing?", answer: "The profanity in Oppenheimer is rated as Moderate. Features approximately 8 uses of strong profanity (F-words), occasional moderate vulgarities, mild anatomical and scatological references, alongside aggressive personal insults during closed-door interrogation scenes." },
        { question: "Why is Oppenheimer rated R?", answer: "Oppenheimer earns its R rating due to explicit sexual content and nudity, disturbing atomic aftermath imagery, a tragic suicide, and moderate profanity. Specifically, the film features Florence Pugh in full-body and topless nude scenes, intense psychological visions of atomic aftermath, a tragic suicide by drowning, and approximately 8–9 F-words. Adults can use Filmiway skip timestamps to navigate past the explicit content." },
