...
export const PTA_MOVIE_FAQS = {
    ...
    "Magnolia": [
        { question: "Does Magnolia have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Magnolia is rated as Moderate. Moderate disturbing content including suicides, hanging imagery, brief bloody injuries, implied animal death, emotional physical altercations, and unsettling surreal sequences." },
        { question: "Does Magnolia have profanity or swearing?", answer: "The profanity in Magnolia is rated as High. Severe strong language throughout including over 170 uses of the F-word, repeated sexual insults, racial slurs, and frequent crude profanity." },
        { question: "Why is Magnolia rated 18+?", answer: "Magnolia earns its 18+ rating for mature themes, moderate violence, explicit sex and brief nudity, and strong language throughout. Specifically, the film contains: Moderate disturbing content including suicides, hanging imagery, brief bloody injuries, implied animal death, emotional physical altercations, and unsettling surreal sequences. Severe strong language throughout including over 170 uses of the F-word, repeated sexual insults, racial slurs, and frequent crude profanity. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
