...
export const GREED_MOVIE_FAQS = {
    ...
    'The Big Short': [
        { question: "Does The Big Short have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in The Big Short is rated as Mild. No notable violence is shown, aside from brief disturbing references and isolated moments such as an eye injury and an implied suicide discussed in dialogue. The film otherwise contains no on-screen violent content." },
        { question: "Does The Big Short have profanity or swearing?", answer: "The profanity in The Big Short is rated as High. Strong language throughout, including over 70 uses of the F-word and variations, frequent scatological references, and repeated mild obscenities. The dialogue also includes extensive name-calling and insulting language." },
        { question: "Why is The Big Short rated 16+?", answer: "The Big Short earns its 16+ rating for frequent strong language and nudity. Specifically, the film contains: No notable violence is shown, aside from brief disturbing references and isolated moments such as an eye injury and an implied suicide discussed in dialogue. The film otherwise contains no on-screen violent content. Strong language throughout, including over 70 uses of the F-word and variations, frequent scatological references, and repeated mild obscenities. The dialogue also includes extensive name-calling and insulting language. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
    ...
    'Uncut Gems': [
        { question: "Does Uncut Gems have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Uncut Gems is rated as Moderate. Moderate violence including intense fights, bloody injuries, physical assaults, and one sudden graphic shooting with visible blood spray." },
        { question: "Does Uncut Gems have profanity or swearing?", answer: "The profanity in Uncut Gems is rated as High. Extremely strong language throughout including 500+ uses of the F-word, constant crude sexual references, repeated vulgar terms, and pervasive coarse dialogue." },
        { question: "Why is Uncut Gems rated 16+?", answer: "Uncut Gems earns its 16+ rating for moderate violence, minor sexual content, and strong language throughout. Specifically, the film contains: Moderate violence including intense fights, bloody injuries, physical assaults, and one sudden graphic shooting with visible blood spray. Extremely strong language throughout including 500+ uses of the F-word, constant crude sexual references, repeated vulgar terms, and pervasive coarse dialogue. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
