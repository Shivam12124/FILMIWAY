...
export const SCI_FI_MOVIES = [
  ...
  },
  {
    ...
    budget: '$11 million',
    synopsis: "In a galaxy far, far away, the evil Galactic Empire has conquered most of the known universe. A young farm boy named Luke Skywalker discovers he is the son of an old Jedi warrior and joins him on a quest to rescue a princess (Carrie Fisher) and destroy the Empire's ultimate weapon: the Death Star. An epic space opera that revolutionized cinema and imagination.",
    poster: '/path/to/starwars-poster.jpg',
    backdrop: '/path/to/starwars-backdrop.jpg',
    backdrop_path: '/path/to/starwars-backdrop.jpg',
    poster_path: '/path/to/starwars-poster.jpg',
    scenes: [
      { time: 25, intensity: 45, label: 'Death Star Attack', color: '#000080' },
      { time: 68, intensity: 65, label: 'Cantina Meeting', color: '#ff8c00' },
      { time: 95, intensity: 78, label: 'Lightsaber Duel', color: '#ff0000' },
      { time: 112, intensity: 88, label: 'Death Star Approach', color: '#ffff00' },
      { time: 118, intensity: 92, label: 'Trench Run', color: '#ffa500' }
    ],
    sciFiComplexity: 88,
    complexityLevel: 'HIGH',
