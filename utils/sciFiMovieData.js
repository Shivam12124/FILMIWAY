...
export const SCI_FI_FAQS = {
  ...
  'Blade Runner 2049': [
        { question: "Does Blade Runner 2049 have violence and gore?", answer: "According to the Filmiway Parents Guide, the violence in Blade Runner 2049 is rated as Moderate. Moderate to strong featuring shootings, stabbings, explosions, drowning, hand-to-hand combat, bloody injuries, disturbing deaths, and occasional graphic aftermath imagery." },
        { question: "Does Blade Runner 2049 have profanity or swearing?", answer: "The profanity in Blade Runner 2049 is rated as Moderate. Moderate language throughout, including around 7 uses of the F-word, occasional coarse profanity, mild obscenities, insulting name-calling." },
        { question: "Why is Blade Runner 2049 rated 15+?", answer: "Blade Runner 2049 earns its 15+ rating for moderate violence, heavy nudity, and moderate language. Specifically, the film contains: Moderate to strong featuring shootings, stabbings, explosions, drowning, hand-to-hand combat, bloody injuries, disturbing deaths, and occasional graphic aftermath imagery. Moderate language throughout, including around 7 uses of the F-word, occasional coarse profanity, mild obscenities, insulting name-calling. The film contains mature scenes some people might find uncomfortable. They can use our timestamps to skip it." },
...
export const generateCleanMovieSchema = (movie, tmdbData, currentMovieYear, collectionSlug, unused, movieInfo) => {
    ...
    const staticFaqs = SCI_FI_FAQS[movie.Title] ? [...SCI_FI_FAQS[movie.Title]] : [];
...
export const getVisibleMovieFAQs = (movieTitle, tmdbId, currentRuntime = "Official") => {
    const staticFaqs = SCI_FI_FAQS[movieTitle] ? [...SCI_FI_FAQS[movieTitle]] : [];
    const sensitiveScenes = SENSITIVE_TIMELINES[tmdbId]?.scenes || [];
    const movieInfo = COMPLETE_SCI_FI_DETAILS[tmdbId];
    const intensityScenes = movieInfo?.scenes || [];

    const dbMovie = SCI_FI_MOVIES.find(m => m.tmdbId === tmdbId);
